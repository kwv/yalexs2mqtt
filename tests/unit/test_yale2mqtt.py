# tests/unit/test_yalexs2mqtt.py
import pytest
...
def test_onStatusUpdate(mock_client_class):
    ...
    # Instantiate bridge (will use mocked config from import time or we need to mock again if it reloads)
    ...
    bridge.mqtt_client.publish.assert_called_once_with("yalexs/ASDFGH1234/currentValue", "LOCKED", retain=True)